...
MLI::MLI(vector<uint> top, float givenRate)
...
void MLI::forwardProp(ColVector& input) {
...
void MLI::backwardProp(ColVector& output) {
	this->errCalc(output);
	this->updateWeights();
}

void MLI::errCalc(ColVector& output) {
...
void MLI::train(vector<ColVector*> input_data, vector<ColVector*> output_data) {
